...
export default function ServicesPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      features: ['Gel polish', 'UV curing', 'Lasts 2-3 weeks', 'Chip-resistant'],
      popular: true
    },
    {
      category: 'manicure',
      name: 'Luxury Manicure',
      description: 'Premium treatment with exfoliation, mask, and extended massage',
      duration: '60 min',
      price: '$55',
      image: 'https://images.unsplash.com/photo-1632345031435-8727f6897d53?w=600',
      features: ['Exfoliation', 'Hydrating mask', 'Extended massage', 'Premium polish'],
      popular: false
    },
    {
      category: 'pedicure',
    ...
    },
    {
      ...
      features: ['Gel polish', 'Extended foot care', 'Lasts 3-4 weeks', 'Relaxing massage'],
      popular: true
    },
    {
      category: 'pedicure',
      name: 'Spa Pedicure',
      description: 'Ultimate relaxation with hot stone massage and paraffin treatment',
      duration: '75 min',
      price: '$75',
      image: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=600',
      features: ['Hot stone massage', 'Paraffin treatment', 'Sugar scrub', 'Hydrating mask'],
      popular: false
    },
    {
      category: 'nail-art',
      ...
      price: '$65+',
      image: 'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=600',
      features: ['Custom design', 'Hand-painted', 'Gem application', 'Unique patterns'],
      popular: true
    },
    {
      category: 'nail-art',
      ...
      price: '$35',
      image: 'https://images.unsplash.com/photo-1610992015732-2449b76344bc?w=600',
      features: ['Classic white tips', 'Natural base', 'Perfect finish', 'Elegant look'],
      popular: false
    },
    {
      category: 'nail-art',
      ...
      price: '$50',
      image: 'https://images.unsplash.com/photo-1632345031435-8727f6897d53?w=600',
      features: ['Gradient colors', 'Smooth transition', 'Modern style', 'Trendy look'],
      popular: false
    },
    {
      category: 'spa',
      ...
      price: '$30',
      image: 'https://images.unsplash.com/photo-1519014816548-bf5fe059798b?w=600',
      features: ['Deep exfoliation', 'Hydrating mask', 'Paraffin dip', 'Intensive moisture'],
      popular: false
    },
    {
      category: 'spa',
      ...
      price: '$40',
      image: 'https://images.unsplash.com/photo-1607779097040-26e80aa78e66?w=600',
      features: ['Dead sea salt soak', 'Sugar scrub', 'Hot towel wrap', 'Deep massage'],
      popular: false
    },
    {
      category: 'spa',
      ...
      price: '$95',
      image: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=600',
      features: ['Full spa treatment', 'Hand & foot care', 'Hot stones', 'Premium products'],
      popular: true
    }
  ];
    ...
    <div className="bg-[#f5f1ed]">
      ...
      <section ref={heroRef} className="relative min-h-[60vh] flex items-center justify-center overflow-hidden py-20 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            From classic manicures to custom nail art, we offer a complete range of services
          </motion.p>
        </div>
      </section>

      {/* Services Grid Section */}
      <section ref={servicesRef} className="bg-white py-20 px-6">
      ...
      {/* Add-ons Section */}
      <section ref={addonsRef} className="bg-white py-20 px-6">
