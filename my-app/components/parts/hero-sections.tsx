    ...
    <section className="relative min-h-[90vh] flex flex-col bg-gradient-to-br from-brand-green via-brand-green to-green-400 overflow-hidden">
      ...
      <div className="relative flex-1 max-w-[1600px] mx-auto w-full px-6 grid lg:grid-cols-2 gap-12 items-center py-12 mt-20">
        ...
        >
          ...
          >
            Your premier destination for luxury nail care and relaxation in
            Kitchener. Experience professional artistry in a serene, hygienic
            environment.
          </motion.p>
          ...
          >
            <Button
              asChild
              className="group w-full sm:w-auto h-14 px-8 rounded-full bg-white text-brand-green hover:bg-emerald-50 text-lg font-italiana tracking-widest transition-all shadow-lg hover:shadow-2xl hover:scale-105"
            >
              <Link
            ...
            <Button
              asChild
              variant="outline"
              className="group w-full sm:w-auto h-14 px-8 rounded-full border-2 border-white text-white hover:bg-white hover:text-brand-green text-lg font-italiana tracking-widest transition-all hover:scale-105 backdrop-blur-sm bg-transparent"
            >
              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <h3 className="text-2xl font-italiana text-brand-green">
                      Gel Extensions
                    </h3>
                  </div>
                  <motion.div
                    ...
                    className="w-12 h-12 rounded-full bg-gradient-to-br from-emerald-100 to-emerald-200 flex items-center justify-center border-2 border-brand-green/30"
                  >
                    <Star className="w-5 h-5 text-brand-green fill-brand-green" />
                  </motion.div>
                </div>
                <p className="text-sm text-gray-700 font-old-standard leading-relaxed mb-4">
                  Durable, lightweight, and natural-looking extensions sculpted
                  to perfection.
                </p>
