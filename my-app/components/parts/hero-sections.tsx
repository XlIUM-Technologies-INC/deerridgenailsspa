...
export default function HeroSection() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="bg-[#f5f1ed] px-6 py-16 min-h-[85vh] flex flex-col justify-center relative overflow-hidden"
    >
      ...
      >
        ...
        {[...Array(6)].map((_, i) => (
          ...
          >
            <Sparkles className="text-pink-300/40 w-6 h-6" />
          </motion.div>
        ))}
        ...
        {[...Array(5)].map((_, i) => (
          ...
          >
            <Star className="text-rose-300/30 w-5 h-5" fill="currentColor" />
          </motion.div>
        ))}
        ...
        <motion.div
          ...
          className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-rose-400/15 rounded-full blur-3xl"
        />
      </motion.div>
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-8">
          ...
          <div className="flex-1" ref={titleRef}>
            ...
            {/* Customer Avatars - Moved under text */}
            <motion.div 
          ...
          >
            ...
            <div className="absolute inset-0 overflow-hidden">
              ...
              {/* Red Overlay with Medium Opacity */}
              <motion.div 
                className="absolute inset-0 bg-[#8b2f4a] opacity-60"
                initial={{ opacity: 0 }}
                animate={isInView ? { opacity: 0.6 } : {}}
                transition={{ duration: 0.8, delay: 0.7 }}
              />

              {/* Text with Image Mask - Shows Original Image Through Text */}
              <div 
            ...
            {/* Overlapping Paper Images - 2 Photos Only */}
            <motion.div
        ...
        >
          ...
          >
            <Button
              variant="outline"
              className="rounded-full border-2 border-gray-900 hover:border-[#8b2f4a] hover:text-[#8b2f4a] px-6 py-6 h-auto group"
              aria-label="Make an appointment for nail services"
            >
              <span className="text-lg font-semibold">MAKE APPOINTMENT</span>
              <motion.svg 
