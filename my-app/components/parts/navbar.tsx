      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <div className="flex-1 flex justify-start">
          <Link href="/" className="group">
            <h1
              className={`text-2xl md:text-3xl font-italiana tracking-[0.2em] ${logoColor} transition-colors duration-300`}
            >
        ...
        <div className="md:hidden">
          <Sheet>
            ...
            <SheetContent
              side="right"
              className="bg-brand-green border-none w-full sm:w-[400px] p-0"
            >
